        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CleaningRequests_Statuses_StatusId",
                        column: x => x.StatusId,
                        principalTable: "Statuses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CleaningRequests_TimeSlots_TimeSlotId",
                        column: x => x.TimeSlotId,
                        principalTable: "TimeSlots",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CleaningRequests_UserAddresses_AddressId",
                        column: x => x.AddressId,
                        principalTable: "UserAddresses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CleaningRequests_UserProfiles_ClientId",
                        column: x => x.ClientId,
                        principalTable: "UserProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RequestServices_CleaningRequests_RequestId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "General cleaning of all rooms.", "Basic Cleaning", 50.00m },
                    { 2, "Thorough cleaning including baseboards and behind appliances.", "Deep Cleaning", 100.00m },
                    { 3, "Full deep cleaning for moving out", "Move-out Cleaning", 150.00m }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "3:00 PM", "10:00 AM", "Morning" },
                    { 2, "5:00 PM", "12:00 PM", "Afternoon" },
                    { 3, "8:00 PM", "2:00 PM", "Evenings" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CleaningRequests_AddressId",
                table: "CleaningRequests",
                column: "AddressId");

            migrationBuilder.CreateIndex(
                name: "IX_CleaningRequests_ClientId",
                table: "CleaningRequests",
                column: "ClientId");

            migrationBuilder.CreateIndex(
                name: "IX_CleaningRequests_StatusId",
                table: "CleaningRequests",
                column: "StatusId");

            migrationBuilder.CreateIndex(
                name: "IX_CleaningRequests_TimeSlotId",
                table: "CleaningRequests",
                column: "TimeSlotId");
